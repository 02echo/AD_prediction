...
class MobileViT(nn.Module):
    ...
    def __init__(self, image_size, dims, channels, num_classes, expansion=4, kernel_size=3, patch_size=(2, 2)):
        ...
        self.fc = nn.Sequential()
        self.fc.add_module("linear1", nn.Linear(channels[-1], 128, bias=False))
        self.fc.add_module("relu", nn.ReLU())
        self.fc.add_module("linear2", nn.Linear(128, num_classes, bias=False))
    ...
    def forward(self, x):
        ...
        # 替换为
        x = self.conv_inception_2(x)  # 640 8 8
