...
class MobileViT(nn.Module):
    def __init__(self, image_size, dims, channels, num_classes, size_in1, size_in2, expansion=4, kernel_size=3, patch_size=(2, 2), size_out=16):
        super().__init__()
        ih, iw = image_size
        ph, pw = patch_size
        ...
        self.classify2.add_module("fc1", nn.Linear(17404, 256))  # ref+mri:1126  #gene 17404
        self.classify2.add_module("relu", nn.ReLU())
        self.classify2.add_module("fc2", nn.Linear(256, num_classes))
        # add Inception block
...
def mobilevit_s_fusion(img_size=(256, 256), num_classes=3):
    dims = [144, 192, 240]
    channels = [16, 32, 64, 64, 96, 96, 128, 128, 160, 160, 640]
    size_in1 = 64 * 16  #640 *8*8
    size_in2 = 16380  # gene:16380  # 323  ref clinical:102
...
if __name__ == '__main__':
    ...
    clinical = torch.randn(5, 16380)  # 323  102  16380
    model = mobilevit_s_fusion()

    out, x = model(img, clinical)
    print(out.shape)
